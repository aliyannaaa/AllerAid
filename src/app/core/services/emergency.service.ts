...
export class EmergencyService {
   ...
   */
  pubic calculateDistance(lat1: number, lon1: number, lat2: number, lon2: number): number {
...
export class EmergencyService {
   ...
   */
  public async notifyUser(emergencyId: string, message: string): Promise<void> {
    try {
        console.log(`Notifying user for emergency ${emergencyId}: ${message}`);
        // Add logic to send notification (e.g., push notification, email, etc.)
    } catch (error) {
